...
class GeoDataFrame(GeoDfBase, DataFrame):
    """
    ...
    def from_shapefile(cls, filename, **kwargs):
        ...
        Wraps geopandas.read_shapefile(). For additional help, see read_shapefile()

        """
        return io.file.read_shapefile(filename, **kwargs)
